...
Fixed version with correct DNS imports
"""
...
import ssl
import re
import dns.resolver  # This is the correct import from dnspython
import hashlib
import requests
...
# Try to import cryptography, but provide fallback if not available
try:
